...
<head>
	<title> Quiz Details</title> <!--title of the page -->
...
<body>
	...
	<article class="module width_full">
			<header><h3>&nbsp;&nbsp;&nbsp;Quiz Details:</h3></header>
			<div class="module_content"><!-- Showing the list of subject for the quiz details-->
					...
					<div>
						...
						<table width="100%" align="center">
							...
							<td style="color:grey;"> <?php echo "Quiz";?></td><!--Posting  Task Type-->
							</tr>
							...
							<tr>
								<td style="font-weight:bold; font-size:15px;">Quiz: </td>
								<td style="color:grey;">
									<?php
									...
									<td style="font-weight:bold; font-size:15px;">Quiz Solution: </td>
									<td style="color:grey;">
									<?php
							...
							<tr>
								<td colspan="4" align="center">
									<a href="subjectassignments.php?&id=<?php echo $subjectID?>&sID=<?php echo $sectionID?>&name=<?php echo $subName;?>&type=<?php echo "q";?>">
