...
<head>
	<title> Final Details</title> <!--title of the page -->
...
<body>
	...
	<?php
		...
		else redirect_to("subjectfinal.php?ErrorID=5&id=<?php echo $subjectID?>&sID=<?php echo $sectionID?>&name=<?php echo $subName;?>&type=<?php echo $type;?>");//redirecting toward subject lecture page
	?>
	<article class="module width_full">
			<header><h3>&nbsp;&nbsp;&nbsp;Final Exam Details:</h3></header>
			<div class="module_content"><!-- Showing the list of subject for the final marks-->
					...
					<div>
						...
						<table width="100%" align="center">
							...
							<td style="color:grey;"> <?php echo "Final Exam";?></td><!--Posting  Task Type-->
							</tr>
							...
							<tr>
								<td colspan="4" align="center">
									<a href="subjectfinal.php?&id=<?php echo $subjectID?>&sID=<?php echo $sectionID?>&name=<?php echo $subName;?>&type=<?php echo "f";?>">
