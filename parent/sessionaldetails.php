...
<head>
	<title> Sessional Details</title> <!--title of the page -->
...
<body>
	...
	<?php
		...
		else redirect_to("subjectsessional.php?ErrorID=5&id=<?php echo $subjectID?>&sID=<?php echo $sectionID?>&name=<?php echo $subName;?>&type=<?php echo $type;?>");//redirecting toward subject lecture page
	?>
	<article class="module width_full">
			<header><h3>&nbsp;&nbsp;&nbsp;Sessional Details:</h3></header>
			<div class="module_content"><!-- Showing the list of subject for the sessional details-->
					...
					<div>
						...
						<table width="100%" align="center">
							...
							<td style="color:grey;"> <?php echo "Sessional";?></td><!--Posting  Task Type-->
							</tr>
							...
							<tr>
								...
								<td style="color:grey;"> <?php echo $res['IssueDate'];?></td><!--Posting Due Date-->
							</tr>
							...
							<tr>
								<td style="font-weight:bold; font-size:15px;">Sessional: </td>
								<td style="color:grey;">
									<?php
									...
									<td style="font-weight:bold; font-size:15px;">Sessional Solution: </td>
									<td style="color:grey;">
									<?php
							...
							<tr>
								<td colspan="4" align="center">
									<a href="subjectsessional.php?&id=<?php echo $subjectID?>&sID=<?php echo $sectionID?>&name=<?php echo $subName;?>&type=<?php echo "s";?>">
