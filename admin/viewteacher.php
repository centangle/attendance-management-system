...
<head>
	<title> View Teacher</title> <!-- Title of the Page -->
                                ...
                                <div class="da-panel-content">
                                    <table id="da-ex-datatable-numberpaging" class="da-table">
                                        ...
                                        <tbody>
											...
											$res=mysql_query("SELECT * FROM `teacher`"); // applying query to generate list of diciplines
											while($row = mysql_fetch_array($res))//will return the list of coordinators from database
												{
												$deleteID=$row['TeacherID']; //maintaing the Delete ID for deleting ny record
											?>
                                            <tr>
