...
<body>
	<?php include"teacherheader.php"; ?><!--sidebar menu for the teacher -->
						<?php
	...
	<table class="inlineSetting" cellpadding="0" cellspacing="0">
		<tr>
			<td>
							...
							?>
					<fieldset>
						<legend><h2>Teacher Profile:</h2></legend>
							<table cellpadding="10px" width="700" border="0" align="center"><!--setting up table fields for profile -->
									...
									<tr>
										...
										<td rowspan="4">
											<img src="../uploadimages/teacher/<?php echo $row['Image']?>" alt="profilePicture" width="140px" height="150px"/><!--Posting  Image-->
										</td>
									</tr>
									<tr>
							...
							<p colspan="2" align="center"><a href="updateteacherprofile.php?id=<?php echo $id?>"><input type="submit" value="Edit Profile"/></a></p>
					</fieldset>
			</td>
		</tr>
	</table>
