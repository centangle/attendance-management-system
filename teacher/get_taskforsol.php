			...
			<table id="da-ex-datatable-numberpaging" class="da-table">
				...
				<tbody>
					<?php
						...
						$sql=mysql_query("SELECT *FROM task WHERE TeacherID='$teacherID' AND TaskType='a'");
					...
					?>
							<tr>
							   ...
							   <td><?php echo $row['DueDate']; ?></td><!-- printing issue date-->
							   <td>
									<?php
							   ...
							   <td>
							   <?php
									$status=$row['SolutionID'];
									if(is_null($status))
									{
							   ?>
								<a href="addsolutiondetails.php?tid=<?php echo $taskID;?>&sbID=<?php echo $subjectID;?>&scID=<?php echo $sectionID;?>">
									<img src="../images/ic_plus.png"width="16" height="16" alt="Add"> Add
								</a><!--Delete Page Refference -->
								<?php
									}
									else echo "<b>Solution Uploaded</b>";
								?>
							   </td>
							</tr>
				    <?php
