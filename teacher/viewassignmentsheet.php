...
?>
	<table align="center" border="0" width="900" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td><pre>       </pre></td>
			<td align="center" rowspan="2"><br/><h1><font color="grey">Mobile-based Student Information System</font></h1><h3>Marks Sheet of Assignment No: _______</h3></td>
		</tr>
	</table>
	<br/>
	<table align="center" border="0" width="900" cellspacing="0" cellpadding="0">
	...
	<p align="center">Click <a class="btnPrint" href="viewassignmentsheet.php?scID=<?php echo $sectionID;?>&sbID=<?php echo $subjectID;?>">Here</a> For Print Version</p>
<?php
}
else
	{
