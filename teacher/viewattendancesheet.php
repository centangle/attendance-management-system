...
?>
	<table align="center" border="0" width="900" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td><pre>       </pre></td>
			<td align="center" rowspan="2"><br/><h1><font color="grey">Mobile-based Student Information System</font></h1><h3>Attendance Sheet</h3></td>
		</tr>
	</table>
	<br/>
	<table align="center" border="0" width="900" cellspacing="0" cellpadding="0">
	...
	<br/><br/>
	<table align="center" border="1" width="1324" cellspacing="4" cellpadding="4">
		<thead>
			<th>Sr.No.</th>
		...
		<tbody>
			...
			?>
				<tr>
					...
					<td width="12%">&nbsp;&nbsp;&nbsp;<?php $studentReg=$row1['RegistrationNo']; echo $studentReg; ?></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
	...
	<p align="center">Click <a class="btnPrint" href="viewattendancesheet.php?scID=<?php echo $sectionID;?>&sbID=<?php echo $subjectID;?>">Here</a> For Print Version</p>
<?php
}
else
	{
