				...
				<tbody>
					...
					?>
							<tr>
							   ...
							   <td>
								<a href="taskdetails.php?tid=<?php echo $taskID;?>&sbID=<?php echo $subjectID;?>&scID=<?php echo $sectionID; ?>">
									<img src="../images/ic_zoom.png"width="16" height="16" alt="View"> View
								</a><!--View Page Refference -->
							   </td><!-- printing description-->
							   <td>
								<?php
									$sql13=mysql_query("SELECT *FROM marks WHERE TaskID='$taskID'");//checking either value exits in database or not
									$val=mysql_num_rows($sql13);
									if($val==0)
									{
								?>
								<a href="addtaskmarks.php?tid=<?php echo $taskID;?>&sbID=<?php echo $subjectID;?>&scID=<?php echo $sectionID;?>&tm=<?php echo $totMarks;?>">
									<img src="../images/ic_plus.png"width="16" height="16" alt="Cancel"> Add
								...
								<?php
									...
									{
								?>
								<a href="viewtaskmarks.php?tid=<?php echo $taskID;?>&sbID=<?php echo $subjectID;?>&scID=<?php echo $sectionID; ?>">
