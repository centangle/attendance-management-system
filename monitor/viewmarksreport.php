...
<?php
	...
	$sql=mysql_query("SELECT *FROM task WHERE TaskID='$taskID'");
...
?>
	<table align="center" border="0" width="900" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td><pre>       </pre></td>
			<td align="center" rowspan="2"><br/><h1><font color="grey">Mobile-based Student Information System</font></h1><h3>Award List for <?php echo $task;?></h3></td>
		</tr>
	</table>
	<br/>
	<table align="center" border="0" width="900" cellspacing="0" cellpadding="0">
	...
	<table align="center" border="1" width="900" cellspacing="4" cellpadding="6">
		...
		<tbody>
			<?php
				...
				$sql1=mysql_query("SELECT *FROM marks WHERE TaskID='$taskID'");
				$i=0;	
				while($row1=mysql_fetch_array($sql1))//while fetching the list of records
				{
					...
					$sql13=mysql_query("SELECT *FROM task WHERE TaskID='$taskID'");
					$row13=mysql_fetch_array($sql13);
			?>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;<?php echo ($i+1);?></td>
					<td>&nbsp;&nbsp;&nbsp;<?php $studentReg=$row12['RegistrationNo']; echo $studentReg; ?></td>
					<td>&nbsp;&nbsp;&nbsp;<?php $studentName=$row12['Name']; echo $studentName;?></td>
					<td>&nbsp;&nbsp;&nbsp;<?php $totMarks=$row13['TotalMarks']; echo $totMarks;?></td>
					<td>&nbsp;<?php $obtMarks=$row1['ObtainedMarks']; echo $obtMarks;?></td>
				</tr>
			<?php
				$i++;
				}
	...
	<p align="center">Click <a class="btnPrint" href="viewmarksreport.php?tid=<?php echo $taskID;?>&scID=<?php echo $sectionID;?>&sbID=<?php echo $subjectID;?>">Here</a> For Print Version</p>
<?php
}
else
	{
