...
<head>
	<title> Add Task Solution</title>	<!--title of the page -->
...
<?php
	...
	switch($error){
		case 2://message 2 case
			echo'<script type="text/javascript">alert("Success: Task Solution Added Successfully.");</script>';//showing the alert box to notify the message to the user
			break;
	}
?>
<body>
