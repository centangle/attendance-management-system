...
<body>
	<?php include"teacherheader.php"; ?><!--sidebar menu for the Coordinator -->
			...
			<td>
					...
					<fieldset>
						<legend><h2>Student Profile:</h2></legend>
							...
							<p colspan="2" align="center"><a href="mystudents.php?scID=<?php echo $safeSection;?>&sbID=<?php echo $safeSubject;?>"><button>GoBack</button></a> | <a href="viewstudentresult.php?sid=<?php echo $id;?>&scID=<?php echo $safeSection;?>&sbID=<?php echo $safeSubject;?>"><button>View Result</button></p>
					</fieldset>
			</td>
		</tr>
	</table>
