...
<head>
	...
	<script>
		function isValid(len,lecID)
		{
			...
			if(cnfrm)
			{
				window.location="submitlateattendance.php?PresentIDs="+p+"&AbsentIDs="+a+"&lid="+lecID;
			}
		}
...
<body>
	...
	<h4 class="alert_success"><?php echo "Attendance Not Marked Before. Mark Attendance Now:"?></h4>
	</div>
