...
<head>
	<title> View Tasks</title>	<!--title of the page -->
...
<?php
	...
	switch($error){
		case 1://message 1 case
			echo'<script type="text/javascript">alert("Success: Task Marks Has been Inserted Successfully.");</script>';//showing the alert box to notify the message to the user
			break;
	}
?>
<body>
