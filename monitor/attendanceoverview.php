...
<head>
	<title> Attendance Overview</title>	<!--title of the page -->
...
<?php
		...
		switch($error){
			...
			case 3://message 3 case
				echo'<script type="text/javascript">alert("Success: Attendance Succefully Marked.");</script>';//showing the alert box to notify the message to the user
				break;
		}
?>
...
<body>
	...
	<article class="module width_full">
		<header><h3>&nbsp;&nbsp;&nbsp;Current Semester Classes:</h3></header>
