...
<head>
	<title> Subject Sessionals</title> <!-- Title of the Page -->
	...
	<?php
		...
		switch($error){
			case 5://message 5 case
				echo'<script type="text/javascript">alert("Sessional Details Not Uploaded Yet.");</script>';//showing the alert box to notify the message to the user
				break;
		}
	?>
<!--Start of Body Tag -->
<body>	
	...
	// query data
		...
		{	
			...
			redirect_to("viewsessional.php?ErrorID=5");//redirecting toward view lecture page
	?>
				...
				<div class="da-panel collapsible">
					<div class="da-panel-header">
						<span class="da-panel-title">
							...
							<b>Sessional of <?php echo $subName;?></b>
						</span>
					</div>
								...
								?>
									<tr>
									   ...
									   <td>
										...
										<td>
											<a href="sessionaldetails.php?tid=<?php echo $result[$i]['TaskID'];?>&id=<?php echo $subjectID?>&sID=<?php echo $sectionID?>&name=<?php echo $subName;?>&type=<?php echo "s";?>">
