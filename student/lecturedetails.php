...
<body>
	...
	<?php
		...
		else redirect_to("subjectlectures.php?ErrorID=5&id=<?php echo $subjectID?>&sID=<?php echo $sectionID?>&name=<?php echo $subName;?>");//redirecting toward subject lecture page
	?>
						...
						<table width="100%" align="center">
							...
							<tr>
								<td colspan="4" align="center">
									<a href="subjectlectures.php?&id=<?php echo $subjectID?>&sID=<?php echo $sectionID?>&name=<?php echo $subName;?>">
