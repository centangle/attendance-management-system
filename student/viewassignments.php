...
<head>
	<title> View Assignments</title> <!-- Title of the Page -->
	...
	<?php
		...
		switch($error){
			case 5://message 5 case
				echo'<script type="text/javascript">alert("Assignment Not Uploaded Yet.");</script>';//showing the alert box to notify the message to the user
				break;
		}
	?>
<!--Start of Body Tag -->
<body>	
	<?php include"studentheader.php"; ?> <!-- Side Bar Menu for Administrator -->
		...
		?>
				...
				<h4 class="alert_success">Course Registeration is Open: No Assignments Uploaded Yet!</h4>
				</div>
		<?php
			}
				else
								...
								?>
									<tr>
									   ...
									   <td>
										...
										<td>
											<a href="subjectassignments.php?id=<?php echo $subjects[$i]['SubjectID'];?>&sID=<?php echo $subjects[$i]['SectionID'];?>&name=<?php echo $subjects[$i]['Name'];?>&type=<?php echo "a";?>">
