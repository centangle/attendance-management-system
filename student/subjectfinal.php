...
<head>
	<title> Subject Final</title> <!-- Title of the Page -->
	...
	<?php
		...
		switch($error){
			case 5://message 5 case
				echo'<script type="text/javascript">alert("Final Exam Details Not Uploaded Yet.");</script>';//showing the alert box to notify the message to the user
				break;
		}
	?>
<!--Start of Body Tag -->
<body>	
	...
	// query data
		...
		{	
			...
			redirect_to("viewfinal.php?ErrorID=5");//redirecting toward view lecture page
	?>
								...
								?>
									<tr>
									   ...
									   <td>
										...
										<td>
											<a href="finaldetails.php?tid=<?php echo $result[$i]['TaskID'];?>&id=<?php echo $subjectID?>&sID=<?php echo $sectionID?>&name=<?php echo $subName;?>&type=<?php echo "f";?>">
