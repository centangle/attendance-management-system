...
<head>
	<title> View Lectures</title> <!-- Title of the Page -->
	...
	<?php
		...
		switch($error){
			case 5://message 5 case
				echo'<script type="text/javascript">alert("Lectures Not Uploaded Yet.");</script>';//showing the alert box to notify the message to the user
				break;
		}
	?>
<!--Start of Body Tag -->
<body>	
	<?php include"studentheader.php"; ?> <!-- Side Bar Menu for Administrator -->
		...
		?>
				...
				<h4 class="alert_success">Course Registeration is Open: No Lectures Uploaded Yet!</h4>
				</div>
		<?php
			}
				else
								...
								?>
									<tr>
									   ...
									   <td>
										...
										<td>
											<a href="subjectlectures.php?id=<?php echo $subjects[$i]['SubjectID'];?>&sID=<?php echo $subjects[$i]['SectionID'];?>&name=<?php echo $subjects[$i]['Name'];?>">
