 ...
 <!-- start of header bar -->
    ...
    <section id="secondary_bar">
        ...
        <div class="breadcrumbs_container">
            <article class="breadcrumbs"><a href="index.php">Student Panel</a>
    ...
    <aside id="sidebar" class="column">
        ...
        <!--<a href="courseregisteration.php"><h3>Course Registeration</h3></a>
        <a href="viewassesment.php"><h3>Course Assessment</h3></a>-->
        <h3>Courses</h3>
        <ul class="toggle">
       ...
       <!-- <h3>Tasks</h3>
        ...
        <ul class="toggle">
			...
			<li class="icn_photo"><a href="viewteachertimetable.php">View Teacher TimeTable</a></li>
        </ul>
		<hr />
       <h3>Downloads</h3>
        <ul class="toggle">
       ...
       <h3>Profile</h3>
        <ul class="toggle">
			...
			<!--<li class="icn_folder"><a href="studentfolder.php">Documents</a></li>-->
