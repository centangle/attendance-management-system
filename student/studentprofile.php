...
<head>
	...
	<?php include"../common/library.php"; ?><!--Common Libraries which includes CSS and Javascript -->
						...
						?>
<body>
	<?php include"studentheader.php"; ?><!--sidebar menu for the Coordinator -->
			...
			<td>
					...
					<fieldset>
						<legend><h2>Student Profile:</h2></legend>
							...
							<p colspan="2" align="center"><a href="updatestudentprofile.php?id=<?php echo $id?>"><input type="submit" value="Edit Profile"/></a></p>
					</fieldset>
			</td>
		</tr>
	</table>
