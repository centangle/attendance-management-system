<?php
	...
	session_start();
			...
			$stRollNo=$_POST['studentUsername'];//posting value of username
			
			$registerationNo= $stRollNo;
			...
			if($errflag) //if error flag is true 
			{
				...
				redirect_to("studentlogin.php?msg=Invalid Login Details");//retuning the error message back to the login page
				exit();//then exit
			}
				...
				if($studentID)
				{
					...
					exit;
							...
							redirect_to("studentlogin.php?msg=Invalid Login Details");
							exit();
						}
?>
